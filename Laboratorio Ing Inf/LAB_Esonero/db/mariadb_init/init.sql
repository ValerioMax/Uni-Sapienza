...
('Star Wars: A New Hope', 'George Lucas', 80, 1977, 'Fantascienza', 'Disney+', ''),
('Pulp Fiction', 'Quentin Tarantino', 62, 1994, 'Crime', 'NOW', 'Paramount+'),
('The Shawshank Redemption', 'Frank Darabont', 66, 1994, 'Dramma', 'NOW', ''),
...
('Spirited Away', 'Hayao Miyazaki', 84, 2001, 'Animazione', 'Netflix', ''),
