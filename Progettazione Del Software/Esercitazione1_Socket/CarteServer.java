...
//NOTA:
//1. -Comunicazione unidirezionale c'è solo nel verso Client -> Server mentre in quella bidirezionale può essere anche server a mandare messaggio per primo (a patto che riceva poi) (credo(?))
//2. -Scanner divide la Stringa in Token! (sottostringhe separate da Whitespaces di deafult)
